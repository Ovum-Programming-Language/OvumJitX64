...
void OilCommandAsmCompiler::InitializeIntegerOperations() {
  ...
  std::vector<AssemblyInstruction> int_add_asm = {// pop rbx - правый операнд
  ...
  std::vector<AssemblyInstruction> int_divide_asm = {// pop rbx - делитель
                                                     {AsmCommand::POP, {Register::RBX}},
                                                     // pop rax - делимое
                                                     {AsmCommand::POP, {Register::RAX}},
  ...
  // IntLeftShift: a << b
  std::vector<AssemblyInstruction> int_left_shift_asm = {{AsmCommand::POP, {Register::RCX}}, // количество сдвигов
