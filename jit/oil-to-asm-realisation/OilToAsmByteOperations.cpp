...
void OilCommandAsmCompiler::InitializeByteOperations() {
  // ByteAdd: a + b
  std::vector<AssemblyInstruction> byte_add_asm = {{AsmCommand::POP, {Register::RBX}},
  ...
  // ByteSubtract: a - b
  std::vector<AssemblyInstruction> byte_subtract_asm = {{AsmCommand::POP, {Register::RBX}},
                                                        {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteMultiply: a * b
  std::vector<AssemblyInstruction> byte_multiply_asm = {{AsmCommand::POP, {Register::RBX}},
                                                        {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteDivide: a / b
  std::vector<AssemblyInstruction> byte_divide_asm = {{AsmCommand::POP, {Register::RBX}},
                                                      {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteModulo: a % b
  std::vector<AssemblyInstruction> byte_modulo_asm = {{AsmCommand::POP, {Register::RBX}},
                                                      {AsmCommand::POP, {Register::RAX}},
                                                      {AsmCommand::XOR, {Register::AH, Register::AH}},
                                                      {AsmCommand::DIV, {Register::BL}},
  ...
  // ByteNegate: -a
  std::vector<AssemblyInstruction> byte_negate_asm = {{AsmCommand::POP, {Register::RAX}},
  ...
  // ByteIncrement: a + 1
  std::vector<AssemblyInstruction> byte_increment_asm = {{AsmCommand::POP, {Register::RAX}},
  ...
  // ByteDecrement: a - 1
  std::vector<AssemblyInstruction> byte_decrement_asm = {{AsmCommand::POP, {Register::RAX}},
  ...
  // ByteEqual: a == b
  std::vector<AssemblyInstruction> byte_equal_asm = {{AsmCommand::POP, {Register::RBX}},
                                                     {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteNotEqual: a != b
  std::vector<AssemblyInstruction> byte_not_equal_asm = {{AsmCommand::POP, {Register::RBX}},
                                                         {AsmCommand::POP, {Register::RAX}},
                                                         {AsmCommand::CMP, {Register::AL, Register::BL}},
                                                         {AsmCommand::MOV, {Register::RAX, static_cast<int64_t>(0)}},
  ...
  std::vector<AssemblyInstruction> byte_less_than_asm = {{AsmCommand::POP, {Register::RBX}},
                                                         {AsmCommand::POP, {Register::RAX}},
                                                         {AsmCommand::CMP, {Register::AL, Register::BL}},
                                                         {AsmCommand::MOV, {Register::RAX, static_cast<int64_t>(0)}},
  ...
  // ByteLessEqual: a <= b
  std::vector<AssemblyInstruction> byte_less_equal_asm = {{AsmCommand::POP, {Register::RBX}},
                                                          {AsmCommand::POP, {Register::RAX}},
                                                          {AsmCommand::CMP, {Register::AL, Register::BL}},
                                                          {AsmCommand::MOV, {Register::RAX, static_cast<int64_t>(0)}},
  ...
  // ByteGreaterThan: a > b
  std::vector<AssemblyInstruction> byte_greater_than_asm = {{AsmCommand::POP, {Register::RBX}},
                                                            {AsmCommand::POP, {Register::RAX}},
                                                            {AsmCommand::CMP, {Register::AL, Register::BL}},
                                                            {AsmCommand::MOV, {Register::RAX, static_cast<int64_t>(0)}},
  ...
  // ByteAnd: a & b
  std::vector<AssemblyInstruction> byte_and_asm = {{AsmCommand::POP, {Register::RBX}},
                                                   {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteOr: a | b
  std::vector<AssemblyInstruction> byte_or_asm = {{AsmCommand::POP, {Register::RBX}},
                                                  {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteXor: a ^ b
  std::vector<AssemblyInstruction> byte_xor_asm = {{AsmCommand::POP, {Register::RBX}},
                                                   {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteNot: ~a
  std::vector<AssemblyInstruction> byte_not_asm = {{AsmCommand::POP, {Register::RAX}},
  ...
  // ByteLeftShift: a << b
  std::vector<AssemblyInstruction> byte_left_shift_asm = {{AsmCommand::POP, {Register::RCX}},
                                                          {AsmCommand::POP, {Register::RAX}},
  ...
  // ByteRightShift: a >> b
  std::vector<AssemblyInstruction> byte_right_shift_asm = {{AsmCommand::POP, {Register::RCX}},
                                                           {AsmCommand::POP, {Register::RAX}},
