...
void OilCommandAsmCompiler::InitializeBooleanOperations() {
  // BoolAnd: a && b
  std::vector<AssemblyInstruction> bool_and_asm = {{AsmCommand::POP, {Register::RBX}},
  ...
  // BoolOr: a || b
  std::vector<AssemblyInstruction> bool_or_asm = {{AsmCommand::POP, {Register::RBX}},
                                                  {AsmCommand::POP, {Register::RAX}},
                                                  {AsmCommand::TEST, {Register::RAX, Register::RAX}},
                                                  {AsmCommand::SETNZ, {Register::AL}},
                                                  {AsmCommand::TEST, {Register::RBX, Register::RBX}},
  ...
  // BoolNot: !a
  std::vector<AssemblyInstruction> bool_not_asm = {{AsmCommand::POP, {Register::RAX}},
                                                   {AsmCommand::TEST, {Register::RAX, Register::RAX}},
  ...
  // BoolXor: a ^ b
  std::vector<AssemblyInstruction> bool_xor_asm = {{AsmCommand::POP, {Register::RBX}},
                                                   {AsmCommand::POP, {Register::RAX}},
                                                   {AsmCommand::TEST, {Register::RAX, Register::RAX}},
                                                   {AsmCommand::SETNZ, {Register::AL}},
                                                   {AsmCommand::TEST, {Register::RBX, Register::RBX}},
  ...
  std::vector<AssemblyInstruction> bool_to_byte_asm = {{AsmCommand::POP, {Register::RAX}},
                                                       {AsmCommand::MOVZX, {Register::RAX, Register::AL}},
                                                       {AsmCommand::PUSH, {Register::RAX}}};
