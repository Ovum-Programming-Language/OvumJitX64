...
> **Note:** This repository contains only JIT compiler implementation for the x86_64 architecture for the Ovum Language toolset and is not intended to be used as a standalone project.
...
- Fork the repo (if you're not the maintainer)
  - <https://github.com/Ovum-Programming-Language/OvumJitX64/fork>
